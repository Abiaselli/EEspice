                                                                       ...
                                                                       double h, int mode)
{
    ...
    /*--------------------------------------------can be changed-------------------------------------------------*/
    Diode_assigner_2(1, 0, 1e-12, 26e-3, h, LHS, RHS, solution, mode);
...
int main(int argc, const char **argv)
{
    ...
    std::vector<double> RHS_locate = {
        ...
        Vs_assigner(1, 0, V1_start, LHS, RHS) // vds
    };
    /*----------------------------------------------fixed--------------------------------------------------------*/
    ...
    id_csv[0] = Diode_assigner_2(1, 0, 1e-12, 26e-3, h, LHS, RHS, solution, mode);
    ...
    while (i < n)
    {
        ...
        id_csv[i] = Diode_assigner_2(1, 0, 1e-12, 26e-3, h, LHS, RHS, solution, mode);
