...
int main(){
    ...
    std::vector<int> iteration_counts = {10000, 20000, 40000, 80000, 100000, 200000, 400000};
    ...
    // Outermost loop: iterate through different iteration counts
    for (int num_iterations : iteration_counts) {
        LOG_OUTPUT("\n");
        LOG_OUTPUT("################################################################################\n");
        LOG_OUTPUT("Testing with " << num_iterations << " iterations\n");
        LOG_OUTPUT("################################################################################\n");
