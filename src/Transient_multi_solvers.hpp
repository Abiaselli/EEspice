...
// void timestep_options(double &temp_h, double &next_h_up, double &next_h_down, const TransientSimulator &trans_sim, bool &TMAX_reach, bool &TMIN_reach)
// {
//     if (temp_h >= trans_sim.trans_config.h_MAX)
//     {
//         temp_h = trans_sim.trans_config.h_MAX;
//         TMAX_reach = true;
//     }
//     else if (temp_h <= trans_sim.trans_config.h_MIN)
//     {
//         temp_h = trans_sim.trans_config.h_MIN;
//         TMIN_reach = true;
//     }
...
//     if (next_h_up > trans_sim.trans_config.h_MAX)
//     {
//         next_h_up = trans_sim.trans_config.h_MAX;
//         // TMAX_reach = true;
//     }
//     else if (next_h_up < trans_sim.trans_config.h_MIN)
//     {
//         next_h_down = trans_sim.trans_config.h_MIN;
//         // TMAX_reach = true;
//     }

//     if (next_h_down > trans_sim.trans_config.h_MAX)
//     {
//         next_h_up = trans_sim.trans_config.h_MAX;
//         // TMAX_reach = true;
//     }
//     else if (next_h_down < trans_sim.trans_config.h_MIN)
//     {
//         next_h_down = trans_sim.trans_config.h_MIN;
//         // TMIN_reach = true;
//     }
...
// multi_timestep multi_solution_solver(const double &h, const Transient &trans, const TransientSimulator &trans_sim, const CKTcircuit &ckt, std::vector<Transient> &vec_trans)
// {
...
//     timestep_options(multi_h.h_mid, multi_h.h_up, multi_h.h_down, trans_sim, multi_h.TMAX_reach, multi_h.TMIN_reach); // calculate the next time step, up mid down
...
// arma::vec multi_next_h(Transient &trans,const TransientSimulator &trans_sim, const CKTcircuit &ckt, std::vector<Transient> &vec_trans)
// {
...
//     do
//     {
//         multi_h = multi_solution_solver(temp_h, trans, trans_sim, ckt, vec_trans);
