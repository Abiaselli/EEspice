...
void modelSetup(BSIM4model &model, const double CKTnomTemp){
    ...
    if (!model.BSIM4vddeotGiven)
        model.BSIM4vddeot = (model.BSIM4type == BSIM4_NMOS) ? 1.5 : -1.5;
    ...
    if (!model.BSIM4vth0Given)
        model.BSIM4vth0 = (model.BSIM4type == BSIM4_NMOS) ? 0.7 : -0.7;
    if (!model.BSIM4vfbGiven)
        model.BSIM4vfb = -1.0;
    if (!model.BSIM4euGiven)
        model.BSIM4eu = (model.BSIM4type == BSIM4_NMOS) ? 1.67 : 1.0;
    if (!model.BSIM4ucsGiven)
        model.BSIM4ucs = (model.BSIM4type == BSIM4_NMOS) ? 1.67 : 1.0;
    ...
    if (!model.BSIM4u0Given)
        model.BSIM4u0 = (model.BSIM4type == BSIM4_NMOS) ? 0.067 : 0.025;
    ...
    if (!model.BSIM4aigcGiven)
        model.BSIM4aigc = (model.BSIM4type == BSIM4_NMOS) ? 1.36e-2 : 9.80e-3;
    if (!model.BSIM4bigcGiven)
        model.BSIM4bigc = (model.BSIM4type == BSIM4_NMOS) ? 1.71e-3 : 7.59e-4;
    if (!model.BSIM4cigcGiven)
        model.BSIM4cigc = (model.BSIM4type == BSIM4_NMOS) ? 0.075 : 0.03;
    ...
    {
        model.BSIM4aigsd = (model.BSIM4type == BSIM4_NMOS) ? 1.36e-2 : 9.80e-3;
        if (!model.BSIM4aigsGiven)
            model.BSIM4aigs = (model.BSIM4type == BSIM4_NMOS) ? 1.36e-2 : 9.80e-3;
        if (!model.BSIM4aigdGiven)
            model.BSIM4aigd = (model.BSIM4type == BSIM4_NMOS) ? 1.36e-2 : 9.80e-3;
    }
    ...
    {
        model.BSIM4bigsd = (model.BSIM4type == BSIM4_NMOS) ? 1.71e-3 : 7.59e-4;
        if (!model.BSIM4bigsGiven)
            model.BSIM4bigs = (model.BSIM4type == BSIM4_NMOS) ? 1.71e-3 : 7.59e-4;
        if (!model.BSIM4bigdGiven)
            model.BSIM4bigd = (model.BSIM4type == BSIM4_NMOS) ? 1.71e-3 : 7.59e-4;
    }
    ...
    {
            model.BSIM4cigsd = (model.BSIM4type == BSIM4_NMOS) ? 0.075 : 0.03;
        if (!model.BSIM4cigsGiven)
            model.BSIM4cigs = (model.BSIM4type == BSIM4_NMOS) ? 0.075 : 0.03;
        if (!model.BSIM4cigdGiven)
            model.BSIM4cigd = (model.BSIM4type == BSIM4_NMOS) ? 0.075 : 0.03;
    }
...
/* Well Proximity Effect  */
    ...
    model.DMCGeff = model.BSIM4dmcg - model.BSIM4dmcgt;
    model.DMCIeff = model.BSIM4dmci;
    model.DMDGeff = model.BSIM4dmdg - model.BSIM4dmcgt;
}
...
void instanceSetup(BSIM4model &model, BSIM4V82 &inst){
    ...
    if (!inst.BSIM4wGiven)
        inst.BSIM4w = 5.0e-6;
    if (!inst.BSIM4nfGiven)
        inst.BSIM4nf = 1.0;
    if (!inst.BSIM4minGiven)
        inst.BSIM4min = 0; /* integer */
    if (!inst.BSIM4icVDSGiven)
        inst.BSIM4icVDS = 0.0;
    if (!inst.BSIM4icVGSGiven)
        inst.BSIM4icVGS = 0.0;
    if (!inst.BSIM4icVBSGiven)
        inst.BSIM4icVBS = 0.0;
    if (!inst.BSIM4drainAreaGiven)
        inst.BSIM4drainArea = 0.0;
    if (!inst.BSIM4drainPerimeterGiven)
        inst.BSIM4drainPerimeter = 0.0;
    if (!inst.BSIM4drainSquaresGiven)
        inst.BSIM4drainSquares = 1.0;
    if (!inst.BSIM4sourceAreaGiven)
        inst.BSIM4sourceArea = 0.0;
    if (!inst.BSIM4sourcePerimeterGiven)
        inst.BSIM4sourcePerimeter = 0.0;
    if (!inst.BSIM4sourceSquaresGiven)
        inst.BSIM4sourceSquares = 1.0;

    if (!inst.BSIM4rbdbGiven)
        inst.BSIM4rbdb = model.BSIM4rbdb; /* in ohm */
    if (!inst.BSIM4rbsbGiven)
        inst.BSIM4rbsb = model.BSIM4rbsb;
    if (!inst.BSIM4rbpbGiven)
        inst.BSIM4rbpb = model.BSIM4rbpb;
    if (!inst.BSIM4rbpsGiven)
        inst.BSIM4rbps = model.BSIM4rbps;
    if (!inst.BSIM4rbpdGiven)
        inst.BSIM4rbpd = model.BSIM4rbpd;
    if (!inst.BSIM4delvtoGiven)
        inst.BSIM4delvto = 0.0;
    if (!inst.BSIM4xgwGiven)
        inst.BSIM4xgw = model.BSIM4xgw;
    if (!inst.BSIM4ngconGiven)
        inst.BSIM4ngcon = model.BSIM4ngcon;


    /* Process instance model selectors, some
        * may override their global counterparts
    */
    if (!inst.BSIM4rbodyModGiven)
        inst.BSIM4rbodyMod = model.BSIM4rbodyMod;
    else if ((inst.BSIM4rbodyMod != 0) && (inst.BSIM4rbodyMod != 1) && (inst.BSIM4rbodyMod != 2))
    {   inst.BSIM4rbodyMod = model.BSIM4rbodyMod;
        printf("Warning: rbodyMod has been set to its global value %d.\n",
    model.BSIM4rbodyMod);
    }

    if (!inst.BSIM4rgateModGiven)
        inst.BSIM4rgateMod = model.BSIM4rgateMod;
    else if ((inst.BSIM4rgateMod != 0) && (inst.BSIM4rgateMod != 1)
    && (inst.BSIM4rgateMod != 2) && (inst.BSIM4rgateMod != 3))
    {   inst.BSIM4rgateMod = model.BSIM4rgateMod;
        printf("Warning: rgateMod has been set to its global value %d.\n",
        model.BSIM4rgateMod);
    }

    if (!inst.BSIM4geoModGiven)
        inst.BSIM4geoMod = model.BSIM4geoMod;
    if (!inst.BSIM4rgeoModGiven)
        inst.BSIM4rgeoMod = 0.0;
    if (!inst.BSIM4trnqsModGiven)
        inst.BSIM4trnqsMod = model.BSIM4trnqsMod;
    else if ((inst.BSIM4trnqsMod != 0) && (inst.BSIM4trnqsMod != 1))
    {   inst.BSIM4trnqsMod = model.BSIM4trnqsMod;
        printf("Warning: trnqsMod has been set to its global value %d.\n",
        model.BSIM4trnqsMod);
    }

    if (!inst.BSIM4acnqsModGiven)
        inst.BSIM4acnqsMod = model.BSIM4acnqsMod;
    else if ((inst.BSIM4acnqsMod != 0) && (inst.BSIM4acnqsMod != 1))
    {   inst.BSIM4acnqsMod = model.BSIM4acnqsMod;
    ...
    /* stress effect */
    if (!inst.BSIM4saGiven)
        inst.BSIM4sa = 0.0;
    if (!inst.BSIM4sbGiven)
        inst.BSIM4sb = 0.0;
    if (!inst.BSIM4sdGiven)
        inst.BSIM4sd = 2 * model.BSIM4dmcg;
    /* Well Proximity Effect  */
    if (!inst.BSIM4scaGiven)
        inst.BSIM4sca = 0.0;
    if (!inst.BSIM4scbGiven)
        inst.BSIM4scb = 0.0;
    if (!inst.BSIM4sccGiven)
        inst.BSIM4scc = 0.0;
    if (!inst.BSIM4scGiven)
        inst.BSIM4sc = 0.0; /* m */
